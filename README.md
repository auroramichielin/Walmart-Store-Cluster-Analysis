...
- Three clustering algorithms compared:
  1) K-Means
  2) Hierarchical clustering (Ward linkage), with dendrogram
  3) DBSCAN, with outlier detection
...
▶️ How to Run
1) Download the dataset and place it in the project root as Walmart_Store_sales.csv
2) Run python clustering.py. The script will:
